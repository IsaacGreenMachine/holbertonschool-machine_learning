...
def lenet5(X):
    ...
    c2 = K.layers.Conv2D(16, kernel_size=(5, 5), padding='valid',
                         activation='relu',
                         kernel_initializer='HeNormal')(p1)
    p2 = K.layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2))(c2)
    flat = K.layers.Flatten()(p2)
    layer1 = K.layers.Dense(units=120, kernel_initializer='HeNormal',
                            activation='relu')(flat)
    layer2 = K.layers.Dense(units=84, kernel_initializer='HeNormal',
                            activation='relu')(layer1)
    layer3 = K.layers.Dense(units=10, kernel_initializer='HeNormal',
